  ...
  return (
    <nav className="">
      <main className="flex items-center justify-between bg-[#FFFFFF] rounded-full h-[72px] px-8">
        <div>
          <img src="/assets/TestLogo.svg" alt="logo" className="h-[48px] w-[210px]" />
        </div>
        <div className="flex flex-shrink gap-[24px] flex-row">
          {navComponents.map((navComponent, index) => {
            ...
            return (
              <>
                <div key={name} className={`flex gap-2 items-center justify-center font-bold ${patients ? "p-3 px-5 bg-[#01F0D0] rounded-[5rem]" : ""}`}>
