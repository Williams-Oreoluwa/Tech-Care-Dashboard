      ...
      <div className="flex flex-col items-start justify-center gap-4">
        <div className="flex items-center justify-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <h2 className="text-[14px] text-[#072635] font-bold capitalize leading-[24px]">{date_of_birth}</h2>
          </div>
        </div>
        <div className="flex flex-row items-start justify-center gap-4">
          ...
          <div>
            ...
            <h2 className="text-[14px] text-[#072635] font-bold capitalize leading-[24px]">{gender}</h2>
          </div>
        </div>
        <div className="flex flex-row items-start justify-center gap-4">
          ...
          <div>
            ...
            <h2 className="text-[14px] text-[#072635] font-bold capitalize leading-[24px]"> {phone_number}</h2>
          </div>
        </div>
        <div className="flex flex-row items-start justify-center gap-4  ">
          <img src="/assets/PhoneIcon.svg" alt="" />
          <div>
            ...
            <h2 className="text-[14px] text-[#072635] font-bold capitalize leading-[24px]">{emergency_contact}</h2>
          </div>
        </div>
        <div className="flex flex-row items-start justify-center gap-4 ">
          ...
          <div>
            ...
            <h2 className="text-[14px] text-[#072635] font-bold capitalize leading-[24px]">{insurance_type}</h2>
          </div>
        </div>
      </div>
